...
dataset_classes = {
    ...
    'VEDAI': ('Car', 'Truck', 'Ship', 'Tractor', 'Camping-Car', 'van', 'vehicle',
              'pick-up', 'plane'),
    'EAGLE': ('pkw', 'lkw'),
    'plad': ('tower', 'insulator', 'spacer', 'damper', 'plate'),
    ...
    'FURNAS': ('baliser_ok', 'baliser_aok', 'baliser_nok', 'insulator_ok', 'insulator_nok', 'bird_nest'
               , 'stockbridge_ok', 'stockbridge_nok', 'spacer_ok', 'spacer_nok', 'insulator_unk'),
    'RAREPLANES': ('Small_Civil_Transport_Utility', 'Medium_Civil_Transport_Utility', 'Large_Civil_Transport_Utility',
               'Military_Transport_Utility_AWAC', 'Military_Bomber', 'Military_Fighter_Interceptor_Attack'
               , 'Military_Trainer'),
}
...
dataset_aliases = {
    ...
    'RAREPLANES': ['RAREPLANES', 'rareplanes'],
}
