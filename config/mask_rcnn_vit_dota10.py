...
data_root = '/ssd_data/xxy/dataset/split_ms_dota1_0/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'test2/annfiles/',
...
evaluation = None
# resume_from = '/home/xxy/projects/RSP/Object Detection/work_dirs/mask_rcnn_prompt_dota10/train/latest.pth'
...
model = dict(
    type='MaskRCNN',
    pretrained='/ssd_data/xxy/projects/RSP/ViT-Base-GPU.pth',
    backbone=dict(
        type='ViT_Deep_Plus',
        img_size=1024,
        embed_dim=768,
