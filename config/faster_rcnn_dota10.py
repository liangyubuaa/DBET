...
data_root = '/ssd_data/xxy/dataset/split_ms_dota1_0/' #'/workspace/CV/users/wangdi153/Dataset/dota_1024_ms/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'train/annfiles/',#'trainval/annfiles/',
        img_prefix=data_root + 'train/images/',
        pipeline=train_pipeline),
    test=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'test2/annfiles/',#'test/annfiles/',
        img_prefix=data_root + 'test2/images/',
...
evaluation = None
# resume_from = '/ssd_data/xxy/projects/RSP/Object Detection/work_dirs/time_calculator/DOTA/rvsa_shallow/latest.pth'

model = dict(
    type='OrientedRCNN',
    pretrained='/ssd_data/xxy/projects/RSP/vit-b-checkpoint-1599.pth',#'../mae-main/output/millionAID_224/1600_0.75_0.00015_0.05_2048/checkpoint-1599.pth',
    backbone=dict(
        type='ViT_RVSA_Deep_Plus',
        img_size=1024,
        embed_dim=768,
        depth=12,
        num_heads=12,
