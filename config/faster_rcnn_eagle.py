...
data_root = '/ssd_data/xxy/dataset/split_ms_EAGLE/' #'/workspace/CV/users/wangdi153/Dataset/dota_1024_ms/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'trainval/annfiles/',#'trainval/annfiles/',
        img_prefix=data_root + 'trainval/images/',
        pipeline=train_pipeline),
    test=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'test/annfiles/',#'test/annfiles/',
...
# resume_from = '/home/xxy/projects/RSP/Object Detection/work_dirs/faster_rcnn_eagle_2x/train_coco_frozen/latest.pth'
evaluation = None
...
model = dict(
    ...
    backbone=dict(
        type='ViT_Win_RVSA_V3_WSZ7_Frozen',
        img_size=1024,
        embed_dim=768,
        depth=12,
        num_heads=12,
