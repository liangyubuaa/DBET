...
data_root = '/ssd_data/xxy/dataset/split_ms_VEDAI/' #'/workspace/CV/users/wangdi153/Dataset/dota_1024_ms/'
img_norm_cfg = dict(
...
# resume_from = '/mnt/disk1/result/faster_rcnn_prompt_vedai/train_shallow/epoch_12.pth'
evaluation = None

model = dict(
    type='OrientedRCNN',
    pretrained='/home/xxy/projects/RSP/Object Detection/work_dirs/mask_rcnn_dota15/ViT-Base-GPU.pth',#'../mae-main/output/millionAID_224/1600_0.75_0.00015_0.05_2048/checkpoint-1599.pth',
    backbone=dict(
