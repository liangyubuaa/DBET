...
data_root = '/mnt/disk1/split_ms_dota1_5/'
img_norm_cfg = dict(
...
resume_from = '/home/xxy/projects/RSP/Object Detection/work_dirs/mask_rcnn_dota15/train_new/latest.pth'
evaluation = None
...
model = dict(
    type='MaskRCNN',
    pretrained='/home/xxy/projects/RSP/Object Detection/work_dirs/mask_rcnn_dota15/ViT-Base-GPU.pth',
    backbone=dict(
        type='ViT',
        img_size=1024,
        embed_dim=768,
